...
Usage as CLI test mode::
    ...
    python -m crypto_swing_copilot.data.market_data          # full universe
    python -m crypto_swing_copilot.data.market_data BTCUSDT  # single pair
...
def _cli_main() -> None:
    ...
    Usage::
        ...
        python -m crypto_swing_copilot.data.market_data                 # all pairs, all TFs
        python -m crypto_swing_copilot.data.market_data BTCUSDT         # single pair
        python -m crypto_swing_copilot.data.market_data BTCUSDT ETHUSDT # multiple pairs
    """
    import sys
    ...
    console = Console()
    console.print("\n[bold cyan]crypto-swing-copilot · Market Data Fetcher[/bold cyan]\n")
