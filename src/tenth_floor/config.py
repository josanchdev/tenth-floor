...
Resolution order:
  1. ``TENTH_FLOOR_ROOT`` env var (explicit override)
...
Usage::
    ...
    from tenth_floor.config import CONFIG_DIR, DATA_DIR, PROJECT_ROOT
"""
...
def _resolve_project_root() -> Path:
    ...
    1. ``TENTH_FLOOR_ROOT`` environment variable — if set,
    ...
    .. note::
        ...
        ``TENTH_FLOOR_ROOT`` environment variable to the
    ...
    """
    # 1. Explicit env var
    env_root = os.environ.get("TENTH_FLOOR_ROOT")
    if env_root:
    ...
    raise RuntimeError(
        ...
        "Set TENTH_FLOOR_ROOT environment variable to the "
