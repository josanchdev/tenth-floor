...
Usage::
    ...
    python -m tenth_floor.post_tweet --draft-only

    # Interactive: review draft and post
    python -m tenth_floor.post_tweet

    # Specific date
    python -m tenth_floor.post_tweet 2026-03-28
    python -m tenth_floor.post_tweet 2026-03-28 --draft-only
"""
