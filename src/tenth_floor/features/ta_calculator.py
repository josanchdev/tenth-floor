...
Usage as CLI test mode::
    ...
    python -m tenth_floor.features.ta_calculator
    python -m tenth_floor.features.ta_calculator BTCUSDT  # if cached
...
from tenth_floor.data.models import TAIndicators  # noqa: E402
...
def _cli_main() -> None:
    ...
    Usage::
        ...
        python -m tenth_floor.features.ta_calculator           # synthetic
        python -m tenth_floor.features.ta_calculator BTCUSDT   # cached
    """
    import sys
    ...
    console = Console()
    console.print("\n[bold cyan]the-tenth-floor · TA Calculator[/bold cyan]\n")
